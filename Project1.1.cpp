...
int main() {
    ...
    printf("---------------------------------------------------------------\n");
    printf("НЕБЛОКИРУЮЩАЯ (LOCK-FREE) ХЕШ-ТАБЛИЦА НА C\n");
    printf("Использует CAS (Compare-And-Swap) операции\n");
    printf("Хеш-функция: FNV-1a\n");
    printf("---------------------------------------------------------------\n");

    run_all_lockfree_tests();                   /* Запускаем все тесты */
